...
CREATE TABLE {$this->getTable('lowerpriceform')} (
  ...
  `lower_price_type varchar(12) NOT NULL default '',
  ...
  `lower_price_shop` varchar(255) NOT NULL default '',
  `lower_price_city` varchar(32) NOT NULL default '',
  `lower_price_prov` varchar(32) NOT NULL default '',
